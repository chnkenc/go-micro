...
import (
	...
	"github.com/chnkenc/go-micro/runtime/local/build"
	"github.com/chnkenc/go-micro/runtime/local/process"
	proc "github.com/chnkenc/go-micro/runtime/local/process/os"
)
