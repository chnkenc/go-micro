// Package kubernetes is a logger implementing (github.com/chnkenc/go-micro/debug/log).Log
package kubernetes
...
import (
	...
	"github.com/chnkenc/go-micro/debug/log"
	"github.com/chnkenc/go-micro/util/kubernetes/client"
)
